...
You have a persistent Persistent Agent Memory directory at `/Users/mbennett/.claude/agent-memory/scope-drift-reviewer/`. Its contents persist across conversations.
